                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-5">
                        ...
                        <input type="text" name="day_ar" dir="rtl"
                               ...
                               value="{{ old('day_ar') }}" placeholder="الاثنين – الثلاثاء" required>
                    ...
                    <div class="col-md-5">
                        ...
                        <input type="text" name="day_en"
                               ...
                               value="{{ old('day_en') }}" placeholder="Monday – Tuesday" required>
                    ...
                    <div class="col-md-2">
                        ...
                        <select name="day_index" class="form-control @error('day_index') is-invalid @enderror" required>
                            ...
                            <option value="0"  {{ old('day_index')==0  ? 'selected':'' }}>0 — الأحد</option>
                            <option value="1"  {{ old('day_index')==1  ? 'selected':'' }}>1 — الاثنين</option>
                            <option value="2"  {{ old('day_index')==2  ? 'selected':'' }}>2 — الثلاثاء</option>
                            <option value="3"  {{ old('day_index')==3  ? 'selected':'' }}>3 — الأربعاء</option>
                            <option value="4"  {{ old('day_index')==4  ? 'selected':'' }}>4 — الخميس</option>
                            <option value="5"  {{ old('day_index')==5  ? 'selected':'' }}>5 — الجمعة</option>
                            <option value="6"  {{ old('day_index')==6  ? 'selected':'' }}>6 — السبت</option>
                            <option value="-1" {{ old('day_index')==-1 ? 'selected':'' }}>-1 — خاص / رمضان</option>
                        </select>
                        <div class="form-text">للمجموعة (اثنين–ثلاثاء) اختر 1</div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="time" name="open_time" class="form-control"
                               value="{{ old('open_time') }}">
                        <div class="form-text">اتركه فارغاً لو "أوقات خاصة"</div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="note_ar" dir="rtl" class="form-control"
                               value="{{ old('note_ar') }}" placeholder="الغداء · العشاء">
                    </div>
                    ...
                    <div class="col-md-5 d-flex gap-4 align-items-center pt-3">
                        ...
                        <div class="form-check form-switch">
                            ...
                            <label class="form-check-label fw-semibold" for="is_ramadan">
                                <i class="fas fa-moon text-warning me-1"></i>صف رمضان الخاص
                            </label>
                        </div>
                    </div>
