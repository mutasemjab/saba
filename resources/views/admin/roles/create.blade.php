...
@section('title', __('messages.create') . ' ' . __('messages.Roles'))
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1>{{ __('messages.create') }} {{ __('messages.Roles') }}</h1>
                            ...
                            <div class="permission-group">
                                <div class="group-header">
                                    ...
                                    <div class="group-select-all">
                                        <label for="group_{{ $groupName }}" style="margin-bottom: 0 !important;">{{ __('messages.select_all') }}</label>
