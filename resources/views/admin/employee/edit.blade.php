...
@section('title', __('messages.Edit Employee'))
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">{{ __('messages.Edit Employee') }}</h4>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.employee.update', $admin) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="form-text">{{ __('messages.Leave blank to keep current password') }}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <button type="submit" class="btn btn-success">
                                <i class="fas fa-save"></i> {{ __('messages.Update Employee') }}
                            </button>
                        </div>
                    </form>
                </div>
