...
<footer>
    <div class="footer-top">
        <div class="footer-brand">
            <img src="<?php echo e($settingNav && $settingNav->logo ? asset('assets/admin/uploads/' . $settingNav->logo) : asset('assets_front/images/main_logo.png')); ?>"
                alt="سبأ" class="footer-brand-logo">
            <p><?php echo e(__('front.footer_about')); ?></p>
            <div class="footer-social">
                <?php if($settingNav->instagram): ?>
                    <a href="<?php echo e($settingNav->instagram); ?>" target="_blank" class="social-btn"><i
                            class="fab fa-instagram"></i></a>
                <?php endif; ?>
                <?php if($settingNav->facebook): ?>
                    <a href="<?php echo e($settingNav->facebook); ?>" target="_blank" class="social-btn"><i
                            class="fab fa-facebook-f"></i></a>
                <?php endif; ?>
                <?php if($settingNav->twitter): ?>
                    <a href="<?php echo e($settingNav->twitter); ?>" target="_blank" class="social-btn"><i
                            class="fab fa-x-twitter"></i></a>
                <?php endif; ?>
                <?php if(!empty($settingNav->whatsapp_number)): ?>
                    <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $settingNav->whatsapp_number)); ?>"
    ...
    <div class="footer-bottom">
        <p class="footer-copy">© <?php echo e(date('Y')); ?> <span><?php echo e(__('front.site_name')); ?></span> ·
            <?php echo e(__('front.all_rights')); ?></p>
